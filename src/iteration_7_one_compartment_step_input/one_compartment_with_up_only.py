...
def sim_and_plot_up_with_state_and_nmda(experiment: Experiment) -> SimulationResults:
    simulation_results = simulate_with_up_state_and_nmda(experiment)
    plot_simulation(simulation_results)
    return simulation_results


def simulate_with_up_state_and_nmda(experiment: Experiment):
    """
        g --
