...
def show_up_down_states_with_continuous_nmda_current():
    config = {
    ...
    sim_and_plot_experiment_grid_with_nmda_cut_off_in_down_state([experiment_1, experiment_2, experiment_3], title="Exemplify that NMDA persists also when UP State finishes")