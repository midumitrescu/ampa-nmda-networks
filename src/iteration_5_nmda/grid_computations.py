...
from iteration_4_conductance_based_model.conductance_based_model import compute_cvs
from iteration_5_nmda.network_with_nmda import sim
...
def produce_comparrison_plot(experiments: list[Experiment], increasing_g_s, increasing_nu_ext_over_nu_thr, label_for_x_axis: str, label_for_y_axis: str, grid_title: str):
    ...
    def compute_spikes_and_rates(current_experiment):
        ...
        rate_monitor, spike_monitor, _, _, internal_state_monitor = sim(current_experiment)
