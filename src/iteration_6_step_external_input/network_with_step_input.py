...
def simulate_with_step_input(experiment: Experiment, in_testing=True, eq=wang_model):
    ...
    bla = np.vstack((S_high.i, S_high.j))
    print(bla[:, bla[1, :] == 1])
    '''
    array([[  0,   1,   4,   9,  10,  12,  16,  19,  22,  23,  26,  28,  35,
         39,  40,  41,  45,  47,  50,  54,  55,  57,  59,  61,  62,  73,
         74,  75,  76,  79,  82,  84,  87,  89, 100, 102, 103, 106, 108,
        109, 110, 111, 112, 113, 118, 121, 123, 125, 129, 131, 137, 141,
        142, 145, 147, 149, 151, 156, 158, 159, 160, 163, 165, 167, 170,
        172, 173, 178, 179, 181, 189, 196, 197, 199, 200, 201, 203, 205,
        206, 207, 209, 217, 221, 225, 226, 231, 233, 236],
