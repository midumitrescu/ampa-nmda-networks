...
class MyTestCase(unittest.TestCase):
    ...
    def test_up_down_with_wang_numbers(self):
        ...
        wang_recurrent_config = {
            ...
            Experiment.KEY_SIMULATION_CLOCK: 0.1,

            NeuronModelParams.KEY_NEURON_C: 0.05e-3, # Wang: Cm = 0.5 nF for pyramidal cells. We are using microFahrad / cm^2 => we need the extra e-3.
